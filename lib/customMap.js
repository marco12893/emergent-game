const ALLOWED_TERRAINS = new Set(['PLAIN', 'FOREST', 'MOUNTAIN', 'HILLS', 'WATER', 'CITY', 'BARRACKS', 'CASTLE', 'CATHEDRAL', 'FARM', 'LIBRARY', 'WALLS', 'FLOOR'])
...
export const sanitizeCustomMap = (customMap) => {
  ...
  if (!Number.isInteger(width) || !Number.isInteger(height) || width < 3 || width > 12 || height < 3 || height > 10) {
    return null
  }
